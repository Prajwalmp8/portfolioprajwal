...
const Contact = () => {
  ...
  transition={{ duration:1}} id="contact"className='w.full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[lenght:90%_auto]'>
         <motion.h4
  ...
  transition={{ duration:0.5,delay:0.5}}
   className='text-center text-5xl font-Ovo'>Get in touch</motion.h1>
        <motion.p
        initial={{ opacity: 0 }}
  whileInView={{ opacity: 1, }}
  ...
  transition={{ duration:0.5,delay:0.9}}
      onSubmit={onSubmit} className="w-full max-w-lg mx-auto p-6 sm:p-8 bg-gradient-to-br from-gray-50 via-white to-gray-100 
                 rounded-2xl shadow-xl flex flex-col gap-6 border border-gray-200 transition-all duration-500 
                 hover:shadow-2xl">
  ...
  transition={{ duration:0.6,delay:1.1}} 
      ...
      required
      name='name'
      className="flex-1 p-4 border border-gray-300 rounded-xl focus:outline-none 
                 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 focus:ring-offset-white 
  ...
  transition={{ duration:0.6,delay:1.3}} 
    ...
    className="p-4 border border-gray-300 rounded-xl focus:outline-none 
               focus:ring-2 focus:ring-indigo-500 focus:ring-offset-1 focus:ring-offset-white 
 ...
 <div className="flex justify-center mt-6">
  ...
  <p className="mt-4 text-center text-gray-700 font-Ovo text-base sm:text-lg 
