...
const Work = () => {
  ...
  transition={{ duration:0.5,delay:0.5}}  className='text-center text-5xl font-Ovo'>MY latest work</motion.h1>
        <motion.p
          initial={{ opacity: 0 }}
  whileInView={{ opacity: 1 }}
  transition={{ duration:0.5,delay:0.7}}  className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Java Full Stack Developer</motion.p>
      <motion.div
        initial={{ opacity: 0 }}
  whileInView={{ opacity: 1 }}
  ...
  {workData.map((project, index) => (
    ...
    transition={{duration:0.3}}
      ...
      className="relative bg-cover bg-center rounded-xl overflow-hidden shadow-md 
                 transition-transform duration-500 hover:scale-105 hover:shadow-xl group"
  ...
  <h2 className="text-xl font-Ovo text-gray-900 mb-2 transition-colors duration-500 group-hover:text-blue-600">
    {project.title}
  </h2>
  <p className="text-gray-700 transition-colors duration-500 group-hover:text-gray-900">
    {project.description}
  </p>
</div>
        ...
        {/* Icon button */}
        <div className="mt-4">
          <button className="bg-white p-2 rounded-full transition-transform duration-500 
...
<div className="flex justify-center mt-6">
  ...
  transition={{ duration:0.5,delay:1.1}}  
    href="#" 
    className="w-max flex items-center justify-center gap-2 px-4 py-2 border border-gray-500 
               rounded-full text-gray-800 font-Ovo text-sm transition-all duration-300 
               hover:bg-black hover:text-white hover:gap-3"
  >
    Show More 
    <Image 
